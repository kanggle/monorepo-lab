 ...
 * the header. Required by {@code platform/api-gateway-policy.md} and each
 * gateway's {@code specs/services/gateway-service/architecture.md} § Error Matrix.
 *
 ...
 * client.
 *
 * <p><strong>Registration:</strong> see {@link RequestIdFilter} — this class is
 * outside every consumer's base package, so the component scan must name
 * {@code com.example.apigateway} explicitly.
 */
@Component
