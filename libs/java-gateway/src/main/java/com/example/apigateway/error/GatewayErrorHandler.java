 ...
 *
 * <p>Takes its {@link ObjectMapper} as a constructor argument rather than
 * autowiring one: a library that declared its own mapper bean could quietly
 * override a service's Jackson configuration.
 */
