-- =============================================================================
-- TASK-MONO-170 — platform-console full-stack local-dev DEMO seed — IAM
-- =============================================================================
-- Applied against the per-project `iam-mysql` container (auth_db + admin_db)
-- AFTER IAM auth/account/admin services are healthy (IAM Flyway done).
--
--   docker exec -i iam-mysql mysql -uroot -prootpass < 01-iam.sql
--
...
-- per-project iam-mysql container instead of the fed-e2e shared mysql. The
