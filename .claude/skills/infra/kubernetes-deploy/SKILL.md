...
# No single spec — this skill operates across every service's `specs/services/<service>/architecture.md`; the canonical Kubernetes manifest source is the shared `platform/deployment-policy.md`, not a per-service spec.
