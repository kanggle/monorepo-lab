 ...
 * TASK-SCM-BE-056 — same conversion, same sort-preservation shape, kept per-service
 * rather than promoted to {@code libs/} because it is a thin JPA-boundary adapter, not
 * a cross-service technical DTO).
 */
