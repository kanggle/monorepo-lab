 ...
 * <p>
 * Before processing any wms event, the consumer checks if a ProcessedEventRecord
...
public class ProcessedEventRecord {
    ...
    public ProcessedEventRecord(UUID eventId, String tenantId, Instant processedAt, String sourceTopic) {
    ...
    public static ProcessedEventRecord of(UUID eventId, String tenantId, Instant processedAt, String sourceTopic) {
        return new ProcessedEventRecord(eventId, tenantId, processedAt, sourceTopic);
    }
