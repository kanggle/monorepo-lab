...
public class RateLimitConfig {
    ...
    KeyResolver accountKeyResolver() {
        return exchange -> ReactiveSecurityContextHolder.getContext()
                ...
                // (map cannot: Reactor NPEs when a map lambda returns null), so it falls through
                // to the IP key, which is the coarse-but-correct answer for an unidentifiable caller.
