...
class GlobalExceptionHandlerNotFoundTest {
    ...
    @Test
    @DisplayName("HttpRequestMethodNotSupportedException(지원 안 하는 메서드)이 405 METHOD_NOT_ALLOWED로 처리된다 (500 아님)")
    ...
    @Test
    @DisplayName("HttpMediaTypeNotSupportedException(지원 안 하는 Content-Type)이 415 UNSUPPORTED_MEDIA_TYPE로 처리된다 (500 아님)")
