...
**Out of scope:** the shared cross-suite OIDC-PKCE login extraction (TASK-MONO-281 gate); committing the demo seed SQL / compose variants that live under `tests/federation-hardening-e2e/` (separate, root-scoped, and currently intentionally uncommitted).
