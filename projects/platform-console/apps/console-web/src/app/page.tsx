 ...
 * The `(console)` layout enforces the IAM OIDC session guard; an
 * unauthenticated visitor is redirected from there to `/login`.
 *
 * The IAM platform-operations detail (accounts · audit · operators
 * 3-leg composed overview, TASK-PC-FE-005) is no longer the landing —
 * it is reached one click deeper via the **IAM card** on this overview
 ...
 * destination); the catalog `iam.baseRoute` is unchanged (still
 * `/accounts`, FE-002).
 */
