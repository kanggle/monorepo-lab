 ...
 * NON-GAP federated domain (ADR-MONO-013 Phase 4 slice 2; completes
 ...
 * client uses the **GAP OIDC access token** (`getAccessToken()`), NEVER
 * the GAP exchanged operator token (`getOperatorToken()`) — the #569
