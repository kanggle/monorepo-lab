...
import { usePeriodPayouts } from '../hooks/use-ecommerce-settlements';
import {
...
/**
 * Settlement period detail (TASK-PC-FE-221 Phase A) — the per-period payouts
 * list. There is no single GET period-by-id read; the period is identified by
 * `periodId` and the payouts are its content. Owns pagination + query; the
 * server-rendered page-0 result seeds the table. Read-only — payout execution is
 * Phase B. Header follows the ecommerce-ops DetailHeader ghost-back convention.
 *
