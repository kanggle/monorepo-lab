 ...
 *       primary entry (Traefik routes {@code iam.local} there).</li>
 ...
 */
@Component
public class IamHealthReadAdapter extends AbstractHealthReadAdapter
        implements IamHealthReadPort {

    public IamHealthReadAdapter(@Qualifier("gapRestClient") RestClient client) {
        super(client);
    }
}
