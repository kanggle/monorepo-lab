...
│   │   │   └── scm/                   # scm 운영 섹션 (Phase 4 slice 2 — FE-008, backlog)
...
│   │   │   └── index.ts              #   feature public API (배럴)
│   │   └── scm-ops/ ...               # 잔여 도메인별 운영 화면 (Phase 4 slice 2 — FE-008, backlog)
│   └── shared/
