...
public class OAuth2ResourceServerConfig {
    ...
    static final String GATEWAY_NAME = "ecommerce";
    ...
    public OAuth2ResourceServerConfig(
            ...
            @Value("${ecommerce.oauth2.allowed-audiences}") String allowedAudiencesCsv,
            @Value("${ecommerce.oauth2.audience-mode}") String audienceMode,
