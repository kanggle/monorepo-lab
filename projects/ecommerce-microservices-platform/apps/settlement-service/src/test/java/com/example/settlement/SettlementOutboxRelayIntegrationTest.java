 ...
 *
 * <p><b>Verification note (TASK-BE-447 AC-7):</b> originally settlement-service had no
 * Testcontainers CI lane (only order/payment did). TASK-MONO-319 added a dedicated
 * {@code integrationTest} lane for settlement-service, so this {@code @Tag("integration")}
 * test now runs on CI.
 */
