package com.example.review.domain.tenant;

/**
 * Holds the current request's tenant id for the duration of request processing
 * (ADR-MONO-030 §2.2 M2 layer 2 — context propagation; TASK-BE-403). The gateway
 ...
 * adapters and the application-layer event publishing both depend on it without
