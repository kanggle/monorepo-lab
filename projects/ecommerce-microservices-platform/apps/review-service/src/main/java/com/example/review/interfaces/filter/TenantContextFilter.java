package com.example.review.interfaces.filter;
...
/**
 * Binds the request's tenant context (ADR-MONO-030 §2.2 M2 layer 2; TASK-BE-403).
 ...
 *
 * <p>review-service trusts gateway-derived identity headers (it runs no Spring
