package com.example.user.domain.tenant;

/**
 * Holds the current request's tenant id for the duration of request processing
 * (ADR-MONO-030 §2.2 M2 layer 2 — context propagation; TASK-BE-367). The gateway
...
public final class TenantContext {
    ...
    /** Default tenant the original single-store data is backfilled to (V4). */
