 ...
 *
 * <p>product-service trusts gateway-derived identity headers (it runs no Spring
 * Security filter chain), so this is the service-side tenant entry point. A
 * missing/blank header (standalone, public no-tenant token) leaves the context
