...
class AdminSellerControllerSliceTest {
    ...
    @Test
    @DisplayName("GET /api/admin/sellers - 비-ECOMMERCE_OPERATOR 역할은 403")
    ...
    @Test
    @DisplayName("GET /api/admin/sellers/{id} - ECOMMERCE_OPERATOR 헤더로 200 + detail 반환")
    ...
    @Test
    @DisplayName("GET /api/admin/sellers/{id} - 비-ECOMMERCE_OPERATOR 역할은 403")
    ...
    void list_multiRoleHeaderContainingAdmin_returns200() throws Exception {
        ...
        mockMvc.perform(get("/api/admin/sellers")
                        .header(ROLE_HEADER, "ECOMMERCE_OPERATOR,ERP_OPERATOR,SCM_OPERATOR"))
                .andExpect(status().isOk());
    }
    ...
    @Test
    @DisplayName("GET /api/admin/sellers - ECOMMERCE_OPERATOR 없는 멀티롤은 403")
    ...
    @Test
    @DisplayName("POST /api/admin/sellers/{id}/provision - ECOMMERCE_OPERATOR → 204 + provisionPending 위임")
    ...
    @Test
    @DisplayName("POST /api/admin/sellers/{id}/suspend - ECOMMERCE_OPERATOR → 204 + suspend 위임")
    ...
    @Test
    @DisplayName("POST /api/admin/sellers/{id}/close - ECOMMERCE_OPERATOR → 204 + close 위임")
    ...
    @Test
    @DisplayName("POST /api/admin/sellers/{id}/suspend - 비-ECOMMERCE_OPERATOR 은 403")
