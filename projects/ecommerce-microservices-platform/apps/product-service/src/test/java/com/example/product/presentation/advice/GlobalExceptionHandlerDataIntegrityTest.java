 ...
 *
 * <p>This service's handler is the one that had to break the class's {@code @ResponseStatus}
 * convention and return {@link org.springframework.http.ResponseEntity}, because the status
 * is decided at runtime. That makes an end-to-end status assertion worth more here than
 * elsewhere: it confirms the runtime-chosen status actually reaches the response.
 */
