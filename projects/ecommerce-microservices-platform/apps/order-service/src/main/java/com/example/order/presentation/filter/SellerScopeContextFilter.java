 ...
 * OPERATOR plane; CONSUMER (buyer) requests carry no seller authority (F5). A
 * missing/blank/{@code '*'} header leaves the scope unset → unrestricted full-tenant
 * view (net-zero / fail-OPEN, F1).
 */
@Component
