package com.example.shipping.interfaces.rest.filter;
...
/**
 * Binds the request's tenant context (ADR-MONO-030 §2.2 M2 layer 2; TASK-BE-369).
 ...
 *
 * <p>shipping-service trusts gateway-derived identity headers (it runs no Spring
