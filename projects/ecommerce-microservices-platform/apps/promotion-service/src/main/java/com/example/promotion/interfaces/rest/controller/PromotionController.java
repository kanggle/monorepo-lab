...
import com.example.promotion.interfaces.rest.dto.response.PromotionSummaryResponse;
...
public class PromotionController {
    ...
    @GetMapping("/summary")
    public ResponseEntity<PromotionSummaryResponse> getPromotionSummary(
            @RequestHeader("X-User-Role") @NotBlank(message = "X-User-Role 헤더는 필수입니다") String role
    ) {
        return ResponseEntity.ok(
                PromotionSummaryResponse.from(promotionQueryService.getPromotionSummary(role))
        );
    }
