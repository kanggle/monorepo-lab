package com.example.promotion.interfaces.rest.filter;
...
/**
 * Binds the request's tenant context (ADR-MONO-030 §2.2 M2 layer 2; TASK-BE-368).
 ...
 *
 * <p>promotion-service trusts gateway-derived identity headers (it runs no Spring
