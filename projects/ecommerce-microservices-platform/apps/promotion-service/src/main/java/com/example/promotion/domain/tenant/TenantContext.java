package com.example.promotion.domain.tenant;

/**
 * Holds the current request's tenant id for the duration of request processing
 * (ADR-MONO-030 §2.2 M2 layer 2 — context propagation; TASK-BE-368). The gateway
 ...
 * mappers and the application-layer event publishing both depend on it without
 * dragging in Spring or servlet types.
 *
...
public final class TenantContext {
    ...
    /** Default tenant the original single-store data is backfilled to (V6). */
