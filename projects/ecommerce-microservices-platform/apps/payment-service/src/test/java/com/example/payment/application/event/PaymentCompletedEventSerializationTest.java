...
@DisplayName("PaymentCompletedEvent 직렬화 테스트")
class PaymentCompletedEventSerializationTest {
    ...
    void serialize_envelopeFields_areSnakeCase() throws Exception {
        PaymentCompletedEvent event = new PaymentCompletedEvent(
                "evt-123", "PaymentCompleted", "2026-03-24T00:00:00Z",
                "payment-service",
                "ecommerce",
                new PaymentCompletedEvent.Payload("pay-1", "order-1", "user-1", 30000L, "2026-03-24T00:00:00Z")
        );
