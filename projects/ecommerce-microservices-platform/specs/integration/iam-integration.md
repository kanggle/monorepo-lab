...
> ADR-001 (D1=A) 와 GAP 의 [consumer-integration-guide.md](../../../iam-platform/specs/features/consumer-integration-guide.md) 의 ecommerce 적용본이며,
...
- operator 계정 (admin-dashboard) 은 GAP 의 [account internal provisioning API](../../../iam-platform/specs/contracts/http/internal/account-internal-provisioning.md) 또는 admin operator API 로 생성된다.
...
- [ ] GAP 의 `ecommerce` 테넌트 등록 (V0012 시드 또는 admin-service [Tenant Lifecycle API](../../../iam-platform/specs/contracts/http/admin-api.md)).
...
- [GAP auth-api.md § OAuth2 / OIDC Endpoints](../../../iam-platform/specs/contracts/http/auth-api.md)
