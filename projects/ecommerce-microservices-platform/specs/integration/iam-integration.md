...
- [ ] frontend (web-store) 의 NextAuth provider 가 `ecommerce-web-store-client` client_id + IAM authorize endpoint 를 사용하도록 cutover (TASK-FE-067). (운영자 UI 는 platform-console — admin-dashboard 앱 제거, TASK-MONO-259.)
