...
`TASK-BE-540` AC-0 이 `user_id` 축을 확정했다. **판정 근거의 현재 위치는 티켓이 아니라 테스트 Javadoc 이다** — `apps/review-service/src/test/java/com/example/review/ReviewDataIntegrityBackstopIntegrationTest.java:47-48`:
