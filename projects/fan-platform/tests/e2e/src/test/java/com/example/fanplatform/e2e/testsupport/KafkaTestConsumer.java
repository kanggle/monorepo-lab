 ...
 * events emitted by community-service / artist-service via the outbox pattern.
 *
 ...
 *
 * <p>Adapted from the wms-platform live-pair e2e helper.
 */
public final class KafkaTestConsumer implements AutoCloseable {
    ...
    public KafkaTestConsumer(String bootstrapServers, Collection<String> topics) {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "fan-e2e-" + UUID.randomUUID());
        ...
        this.pollThread = new Thread(this::pollLoop, "kafka-fan-e2e-consumer");
