...
/**
 * Verifies the prometheus scrape endpoint isolation contract defined in
 ...
 * the internal docker network ({@code fan-platform-net}) without going through the
 * gateway. See {@code docs/operations/prometheus-scrape.md} for job configuration.
 */
@Tag("integration")
