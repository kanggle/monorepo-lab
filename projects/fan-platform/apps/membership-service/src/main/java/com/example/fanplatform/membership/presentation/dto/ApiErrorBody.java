 ...
 * is documented in {@code specs/contracts/http/membership-api.md} use this type — for
 * membership-service that is {@code MEMBERSHIP_STATE_INVALID} alone. The 2-argument
