 ...
 * Replicates the fan-platform gateway-service validator at the service level
 * (defense-in-depth). D2-b deprecation window: IAM issues both SAS-style and
 * legacy {@code "iam"} tokens.
 */
