 ...
 *
 * <p>Mirrors community-service's validator. The fan-platform gateway already
 * validates this claim, but the service MUST re-validate so that:
 * <ul>
 ...
 * tokens (the same exception the gateway makes).
 */
