...
/**
 * Data-preservation + before/after classification parity for notification-service's {@link PublicPaths}
 ...
 */
@DisplayName("PublicPaths (notification-service) — data preserved exactly across the D5 mechanism promotion")
class PublicPathsTest {
    ...
    void classificationParityBeforeAndAfter() {
        ...
        assertThat(PublicPaths.isPublic("/api/fan/notifications")).isFalse();
