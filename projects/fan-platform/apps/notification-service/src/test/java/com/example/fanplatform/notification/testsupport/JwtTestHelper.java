...
/**
 * Local RSA-backed JWT signer for notification-service tests. Signs end-user
 * tokens (tenant-pinned, role/roles) for the inbox surface. There is no
 * workload-identity surface in this service.
 */
public final class JwtTestHelper {
    ...
    public String signForeignIssuer(String subject) {
        return signWithIssuer(FOREIGN_ISSUER, subject, DEFAULT_TENANT_ID, Map.of());
    }
    ...
    public String signEndUser(String subject, String tenantId, Map<String, Object> additionalClaims) {
        return signWithIssuer(SAS_ISSUER, subject, tenantId, additionalClaims);
    }

    private String signWithIssuer(String issuer, String subject, String tenantId,
