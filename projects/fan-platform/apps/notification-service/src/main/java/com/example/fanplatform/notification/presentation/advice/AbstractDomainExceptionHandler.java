...
/**
 * fan-platform-owned exception-handling policy for notification-service.
...
abstract class AbstractDomainExceptionHandler extends CommonGlobalExceptionHandler {
     ...
     * (`community-api.md`, `artist-api.md`, `membership-api.md` — "422 VALIDATION_ERROR |
     * constraint violation (`@Valid`)"), where the shared default is 400. One override
     * moves both inherited arms; see {@link CommonGlobalExceptionHandler#validationFailureStatus()}.
     */
    @Override
    ...
    /**
     * Not covered by the shared base — without this arm a non-UUID path variable would
     * fall through to the catch-all and regress a documented 400 into a 500.
     */
