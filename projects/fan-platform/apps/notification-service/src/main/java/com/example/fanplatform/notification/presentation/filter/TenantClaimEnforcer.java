package com.example.fanplatform.notification.presentation.filter;

import com.example.fanplatform.notification.domain.tenant.TenantContext;
...
/**
 * Service-level fail-closed re-enforcement of {@code tenant_id} on the inbox
 * surface (multi-tenant.md M2, third layer after gateway + JwtDecoder). Runs
 * after Spring Security has populated the SecurityContext. Skips public actuator
 * paths.
 */
@Slf4j
@Component
