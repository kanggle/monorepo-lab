...
/**
 * Data-preservation + before/after classification parity for community-service's {@link PublicPaths}
 ...
 */
@DisplayName("PublicPaths (community-service) — data preserved exactly across the D5 mechanism promotion")
class PublicPathsTest {
    ...
    void classificationParityBeforeAndAfter() {
        ...
        assertThat(PublicPaths.isPublic("/api/community/posts")).isFalse();
