...
/**
 * fan-platform-owned exception-handling policy for community-service.
...
abstract class AbstractDomainExceptionHandler extends CommonGlobalExceptionHandler {
     ...
     * ({@code community-api.md} — "422 VALIDATION_ERROR | constraint violation
     ...
     * fall through to the catch-all and regress the documented 400 into a 500.
     */
