package com.example.fanplatform.community.domain.tenant;
 ...
 *
 * <p>Intentionally NOT a ThreadLocal — Spring already manages the
 * SecurityContext per request. Reading from there guarantees the value
 * matches what the framework's validators accepted, which is the entire
 * point of the service-level fail-closed re-validation.
 */
