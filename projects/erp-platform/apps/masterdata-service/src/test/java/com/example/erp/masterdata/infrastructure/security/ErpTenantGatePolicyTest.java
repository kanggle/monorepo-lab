...
/**
 * <strong>erp's tenant policy</strong>, pinned — what masterdata-service's gate admits and, just as
 ...
 */
@DisplayName("erp/masterdata-service — the tenant gate's policy, both halves")
class ErpTenantGatePolicyTest {
    ...
    private static final String API_PATH = "/api/erp/employees/emp-1";
