...
/**
 * Error envelope {@code { code, message, details?, timestamp }} (masterdata-api.md).
 *
 ...
 * contract documents {@code details} use it; every other arm in
 * {@code presentation/advice/GlobalExceptionHandler} emits {@code ErrorResponse}.
 *
 ...
 * timestamp for exactly that reason). No observable change here — masterdata-service has
