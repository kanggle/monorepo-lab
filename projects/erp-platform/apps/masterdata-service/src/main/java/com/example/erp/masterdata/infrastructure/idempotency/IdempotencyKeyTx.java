...
import com.example.erp.masterdata.infrastructure.persistence.jpa.IdempotencyKeyJpaRepository;
 ...
 * (FIN-BE-004 final form). <b>Each method is its own {@code REQUIRES_NEW}
 * transaction containing exactly ONE statement.</b>
 *
 * <p>This is a <em>separate bean</em> (not self-invoked methods on
 * {@code DbIdempotencyStore}) for two reasons:
 * <ol>
 ...
 *       transaction and continuing fails commit with
 ...
 * </ol>
 *
 * <p>Byte-stable copy of finance-platform's {@code IdempotencyKeyTx} (do NOT
 * regress to the cycle-1 broken form).
 */
@Component
