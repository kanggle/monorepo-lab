...
/**
 * Per-service transactional-outbox row for approval-service (TASK-ERP-BE-025 —
 ...
 * serialises the UUID as its 36-char canonical string, matching the {@code V5}
 ...
 * {@code OutboxApprovalEventPublisher}); the relay never parses it.
 *
 * <p>Lives under {@code com.example.erp.approval.infrastructure.persistence.jpa}
...
public class ApprovalOutboxJpaEntity implements OutboxRow {
    ...
    protected ApprovalOutboxJpaEntity() {
    }

    private ApprovalOutboxJpaEntity(UUID id, String aggregateType, String aggregateId,
    ...
    public static ApprovalOutboxJpaEntity create(UUID id, String aggregateType, String aggregateId,
                                                 String eventType, String payload,
                                                 String partitionKey, Instant createdAt) {
        return new ApprovalOutboxJpaEntity(id, aggregateType, aggregateId, eventType,
