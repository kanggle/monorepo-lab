...
/**
 * <strong>erp's tenant policy</strong>, pinned — what read-model-service's gate admits and, just as
 ...
 */
@DisplayName("erp/read-model-service — the tenant gate's policy, both halves")
class ErpTenantGatePolicyTest {
    ...
    private static final String API_PATH = "/api/erp/read/employees/emp-1";
