 ...
 * {@code read-model-api.md} documents no code as carrying it (unlike
 ...
 *
 * <p><strong>Validation status</strong> — read-model-api.md publishes
...
public class GlobalExceptionHandler extends CommonGlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(ReadModelNotFoundException e) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(ErrorResponse.of(ReadModelNotFoundException.CODE, e.getMessage()));
    }
