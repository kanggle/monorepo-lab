 ...
 * helper — a decode-pass / filter-block split would otherwise reject a
 * domain-entitled cross-tenant token, TASK-MONO-162 / TASK-ERP-BE-005).
 */
public class TenantClaimValidator implements OAuth2TokenValidator<Jwt> {
     ...
     * strings that contains {@code domain}. Any claim shape anomaly
