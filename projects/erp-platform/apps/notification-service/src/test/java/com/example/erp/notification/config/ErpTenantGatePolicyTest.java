...
/**
 * <strong>erp's tenant policy</strong>, pinned — what notification-service's gate admits and, just as
 ...
 */
@DisplayName("erp/notification-service — the tenant gate's policy, both halves")
class ErpTenantGatePolicyTest {
    ...
    private static final String API_PATH = "/api/erp/notifications/ntf-1";
