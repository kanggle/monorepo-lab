package com.example.erp.gateway;
 ...
 * {@code com.example.erp.gateway}, so without the explicit list those beans would
...
public class GatewayServiceApplication {
    ...
    static final String OWN_PACKAGE = "com.example.erp.gateway";
