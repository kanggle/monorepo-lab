...
/**
 * erp's identity-header policy at the edge (TASK-MONO-357).
 *
 * <p>The filters live in {@code libs/java-gateway}; this class is the whole of what is
 * erp-specific about them. Both beans are read directly by
...
public class GatewayIdentityConfig {
    ...
    /**
     * erp strips exactly {@link IdentityHeaderStripFilter#BASELINE_HEADERS} — the eight
     * headers every gateway strips. It adds none of its own.
     *
     * <p><strong>Nothing downstream reads any of them</strong> — a census across
     * the four erp services (TASK-MONO-357) found zero consumers of
    ...
    /**
     * erp injects the verified identity headers even though no service reads them today.
