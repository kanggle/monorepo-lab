 ...
 * {@code com.wms.gateway}, so without the explicit list those beans would <strong>never
 * register</strong> — and nothing would say so. Every unit test would still pass, because
 * they construct the filters directly; the gateway would simply run without them.
 *
...
public class GatewayServiceApplication {
    ...
    static final String OWN_PACKAGE = "com.wms.gateway";
