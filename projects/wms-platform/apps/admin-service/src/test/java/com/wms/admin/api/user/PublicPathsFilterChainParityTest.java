 ...
 * admin-service's {@link PublicPaths} adoption (ADR-MONO-058 § D5,
 * TASK-BE-570 AC-2).
 *
 ...
 * (its {@code RoleHierarchy} bean is registered automatically via
 * {@code @Import(SecurityConfig.class)}, so no extra {@code @MockitoBean} is
 * needed here).
 */
