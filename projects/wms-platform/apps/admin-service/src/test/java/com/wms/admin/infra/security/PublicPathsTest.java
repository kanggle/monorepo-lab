...
/**
 * Pins admin-service's {@link PublicPaths} (ADR-MONO-058 § D5, TASK-BE-570).
 *
 ...
 */
@DisplayName("admin-service PublicPaths")
class PublicPathsTest {
    ...
    void isPublic_nonPublicPaths_false() {
        ...
        assertThat(PublicPaths.isPublic("/api/v1/admin/users")).isFalse();
    }
}
