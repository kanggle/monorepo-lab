...
-- This was V99__seed_dev_masterref.sql, and inventory production is only at V6,
-- so once V99 applied it became the highest APPLIED version of inventory_db and
