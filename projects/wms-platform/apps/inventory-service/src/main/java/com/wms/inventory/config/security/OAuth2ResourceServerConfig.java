 ...
 * file remains the only place inventory-service's resource-server posture is decided.
 */
@Configuration
public class OAuth2ResourceServerConfig {
    ...
    /**
     * The tenant gate, and the only place inventory-service's tenant policy is stated.
     *
