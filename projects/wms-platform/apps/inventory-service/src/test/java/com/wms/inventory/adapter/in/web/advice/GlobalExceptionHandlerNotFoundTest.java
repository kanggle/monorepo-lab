 ...
 */
@DisplayName("inventory GlobalExceptionHandler — 상속 arm 실배선 + flat 봉투 형태 (ADR-MONO-058 D2)")
class GlobalExceptionHandlerNotFoundTest {
     ...
     * {@code inventory-service-api.md}'s own "VALIDATION_ERROR | 400 | Bad input (type,
     ...
     * inventory-service publishes the <strong>flat</strong> {@code {code, message, timestamp}}
