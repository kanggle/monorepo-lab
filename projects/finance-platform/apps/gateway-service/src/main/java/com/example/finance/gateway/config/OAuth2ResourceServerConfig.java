...
public class OAuth2ResourceServerConfig {
    ...
    static final String GATEWAY_NAME = "finance";
    ...
    public OAuth2ResourceServerConfig(
            ...
            @Value("${financeplatform.oauth2.allowed-audiences}") String allowedAudiencesCsv,
            @Value("${financeplatform.oauth2.audience-mode}") String audienceMode,
