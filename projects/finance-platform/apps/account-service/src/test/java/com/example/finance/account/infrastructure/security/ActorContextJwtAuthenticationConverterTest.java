...
import static com.example.finance.account.infrastructure.security.ActorContextJwtAuthenticationConverter.SUPERADMIN_READ_ROLE;
import static com.example.finance.account.infrastructure.security.ActorContextJwtAuthenticationConverter.VIEWER_ROLE;
import static org.assertj.core.api.Assertions.assertThat;
import static org.assertj.core.api.Assertions.assertThatThrownBy;

/**
 * Unit tests for the account {@link ActorContextJwtAuthenticationConverter}, grouped by concern:
 *
 * <ul>
 ...
 * </ul>
 */
@DisplayName("account ActorContextJwtAuthenticationConverter")
class ActorContextJwtAuthenticationConverterTest {
    ...
    @Nested
    @DisplayName("scope lifting (TASK-FIN-BE-046)")
    class ScopeLifting {
