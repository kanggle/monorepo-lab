 ...
 * {@link NoResourceFoundException} (or {@link NoHandlerFoundException} when
 * {@code spring.mvc.throw-exception-if-no-handler-found} is set), which the
 * unscoped {@code Exception.class} catch-all previously swallowed into a 500.
 * Asserts both now resolve to 404 NOT_FOUND.
 */
