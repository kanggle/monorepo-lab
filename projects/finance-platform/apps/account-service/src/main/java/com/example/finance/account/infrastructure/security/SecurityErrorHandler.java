...
/**
 * Shared security error response writer — extracted from {@link SecurityConfig}
 * to keep config lean and allow independent testing. Handles authentication
 * failure (401 / tenant-mismatch 403) and access denial (403).
 */
@Component
