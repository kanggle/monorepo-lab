package com.example.finance.account.presentation.security;
 ...
 *
 * <p>finance has NO public webhook/callback surface in v1 (unlike scm) — only
 * the actuator probes are unauthenticated (architecture.md § Security).
 */
