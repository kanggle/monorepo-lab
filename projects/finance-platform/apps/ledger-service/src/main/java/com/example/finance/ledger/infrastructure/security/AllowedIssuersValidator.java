 ...
 * (SAS issuer + legacy {@code iam} D2-b window). Mirrors account-service's
 * service-level validator (defense-in-depth — byte-identical to the future
 * finance gateway-service allowed-issuers).
 */
