 ...
 * still 403s on every ledger mutation. Mirrors the account-service fix — finance had applied
 * entitlement-trust at the tenant layer only (TASK-FIN-BE-006 pilot); when the read-scope hardening
