...
class SettleForeignPositionUseCaseTest {
    ...
    @Nested
    @DisplayName("core settlement (gain/loss, no-op, replay, guards)")
    ...
    @Nested
    @DisplayName("partial / weighted-average settlement (12th increment — TASK-FIN-BE-018)")
    class PartialWeightedAverageSettlement {
    ...
    @Nested
    @DisplayName("FIFO lot consumption (17th increment — TASK-FIN-BE-025, ADR-001 D3)")
    class FifoLotConsumption {
    ...
    /**
     * Per-account cost-flow override resolution (21st increment — TASK-FIN-BE-029). Pure
     * static resolver, no Testcontainers (AC-2). Precedence: account override > tenant
     * default > WEIGHTED_AVERAGE.
     */
    @Nested
    @DisplayName("per-account cost-flow override resolution (21st increment — TASK-FIN-BE-029)")
    class PerAccountCostFlowOverrideResolution {
