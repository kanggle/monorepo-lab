 ...
 * {@link GapOidcJwksSubjectTokenValidator}: signature, issuer, audience,
 ...
 * Docker.
 */
@DisplayName("GapOidcJwksSubjectTokenValidator (subject-token validation branches)")
class GapOidcJwksSubjectTokenValidatorTest {
    ...
    private GapOidcJwksSubjectTokenValidator validator;
    ...
    void setUp() throws Exception {
        ...
        GapOidcProperties props = new GapOidcProperties();
        ...
        validator = new GapOidcJwksSubjectTokenValidator(props, new ObjectMapper());
    }
