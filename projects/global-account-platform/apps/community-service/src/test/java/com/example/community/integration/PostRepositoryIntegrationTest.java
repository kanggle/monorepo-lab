...
class PostRepositoryIntegrationTest extends CommunityIntegrationTestBase {
    ...
    void findFeedForFan_returnsOnlyPublishedPostsFromFollowedArtists() {
        stubAccountProfile();
        String fanId = "fan-" + UUID.randomUUID().toString().substring(0, 28);
    ...
    void findFeedForFan_excludesPostsFromUnfollowedArtists() {
        stubAccountProfile();
        String fanId = "fan-" + UUID.randomUUID().toString().substring(0, 28);
        String artistA = "artist-a-" + UUID.randomUUID().toString().substring(0, 28);
        String artistB = "artist-b-" + UUID.randomUUID().toString().substring(0, 28);
