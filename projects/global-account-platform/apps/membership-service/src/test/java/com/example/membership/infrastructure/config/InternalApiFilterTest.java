...
class InternalApiFilterTest {
    ...
    private static final String INTERNAL_PATH = "/internal/membership/access";
    private static final String PUBLIC_PATH = "/api/membership/plans";
    ...
    @Test
    @DisplayName("토큰 미설정 + bypass=true + /internal/** → 통과")
    ...
    @Test
    @DisplayName("/internal/** 외 경로는 토큰 검증 없이 통과")
