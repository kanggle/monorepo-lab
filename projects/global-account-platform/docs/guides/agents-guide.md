...
**핵심 규칙:**
- 모든 결정은 `platform/architecture-decision-rule.md` 우선 준수
...
**참조 워크플로우:** CLAUDE.md Required Workflow 1–3단계, `platform/entrypoint.md` 스펙 읽기 순서
...
- Command/Result, Request/Response 네이밍 패턴 준수 (`platform/naming-conventions.md`)
...
**참조 워크플로우:** `specs/services/<service>/architecture.md`, `specs/contracts/`, `platform/error-handling.md`, `platform/naming-conventions.md`
...
**핵심 규칙:**
- `platform/testing-strategy.md` 준수
...
**참조 워크플로우:** CLAUDE.md Required Workflow 1–3단계, `platform/testing-strategy.md`
...
- `platform/naming-conventions.md` 네이밍 규칙 준수
- `platform/error-handling.md` 에러 응답 형식 준수
- 기존 계약의 breaking change는 사전 합의 없이 변경 금지

**참조 스킬:** 없음 (스펙 직접 참조)

**참조 워크플로우:** `platform/versioning-policy.md`, `platform/error-handling.md`, `platform/naming-conventions.md`
...
**참조 스킬:** 없음 (database 스킬 미작성 — `platform/` 정책 직접 참조)

**참조 워크플로우:** `specs/services/<service>/architecture.md`, `platform/` DB 관련 정책
...
**참조 워크플로우:** `platform/deployment-policy.md`, CLAUDE.md Hard Stop Rules
