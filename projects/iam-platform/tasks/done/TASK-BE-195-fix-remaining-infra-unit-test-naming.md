---
id: TASK-BE-195
title: admin·membership·security-service infrastructure 단위 테스트 파일명 UnitTest 규칙 준수
status: ready
type: TASK-BE
target_service: admin-service, membership-service, security-service
---
...
### admin-service — infrastructure/persistence/rbac (1개)

| 현재 파일명 | 변경 후 파일명 |
|---|---|
| `PermissionEvaluatorImplTest.java` | `PermissionEvaluatorImplUnitTest.java` |

경로: `apps/admin-service/src/test/java/com/example/admin/infrastructure/persistence/rbac/`

### membership-service — infrastructure/redis (1개)

| 현재 파일명 | 변경 후 파일명 |
|---|---|
| `RedisIdempotencyStoreTest.java` | `RedisIdempotencyStoreUnitTest.java` |

경로: `apps/membership-service/src/test/java/com/example/membership/infrastructure/redis/`

### security-service — consumer/handler (1개)

| 현재 파일명 | 변경 후 파일명 |
|---|---|
| `EventDedupServiceTest.java` | `EventDedupServiceUnitTest.java` |

경로: `apps/security-service/src/test/java/com/example/security/consumer/handler/`
