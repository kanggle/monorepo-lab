...
done (2026-09-26 UTC — 4차원 검증 · 맨 아래 § close) ‖ 직전: review — AC-0(**재결정 반영: ⓐ 만 + 데모 VELOCITY 완화**) · AC-1 · AC-2 완료(2026-09-25 UTC). 🔴 **AC-3 · AC-4 는 창(라이브 스택) 항목으로 열려 있다** — 아래 § 창 런북. 단위 테스트 초록은 AC-3 의 판정이 아니다.
...
- (a)(b) impl PR **#4016** MERGED · 스쿼시 `64f1ae516` 가 `origin/main` 조상. 데모 오버레이 후속 **#4026**(`15b68efc2`, VELOCITY 10000) MERGED · 16차 AMI 에 구워짐.
- (c) #4016 머지 전 SUCCESS 19 · SKIPPED 48 · 실패 0 · #4026 SUCCESS 11 · 실패 0.
- (d) AC-0·1·2 체크 · AC-3 = § CORRECTION (2026-09-26) 창 판정 PASS · AC-4 = § AC-4 라이브 판정 PASS. ⇒ **done.**
