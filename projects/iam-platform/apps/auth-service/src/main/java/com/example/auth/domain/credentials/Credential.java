 ...
 *
 * <p>TASK-MONO-263 (ADR-032 D5 step 4 / ADR-MONO-035 4b-2b): the {@code accountType}
 * field (TASK-BE-329) is removed — the {@code account_type} JWT claim is no longer
 * emitted and the {@code credentials.account_type} column is dropped (V0025). Roles
 * (seeded on platform, BE-369; derived at assume-tenant, BE-376) are the sole
 * authorization surface.</p>
 */
public class Credential {
    ...
    /**
     * Canonical constructor (TASK-BE-229).
     */
