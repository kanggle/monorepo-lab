...
public class CredentialJpaEntity {
    ...
    // TASK-MONO-263 (ADR-032 D5 step 4 / ADR-MONO-035 4b-2b): the account_type
    // column (TASK-BE-329) is dropped (V0025). The entity maps it no longer — else
    // Hibernate ddl-auto=validate fails on boot after the DROP.
