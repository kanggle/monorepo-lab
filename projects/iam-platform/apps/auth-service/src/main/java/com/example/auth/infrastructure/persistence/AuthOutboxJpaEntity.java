...
/**
 * Per-service transactional-outbox row for auth-service (TASK-BE-450 — outbox
 ...
 * serialises the UUID as its 36-char canonical string, matching the {@code V0027}
 ...
 * {@code OutboxAuthEventPublisher}); the relay never parses it.
 *
 * <p>Lives under {@code com.example.auth.infrastructure.persistence} (the
...
public class AuthOutboxJpaEntity implements OutboxRow {
    ...
    protected AuthOutboxJpaEntity() {
    }

    private AuthOutboxJpaEntity(UUID id, String aggregateType, String aggregateId,
    ...
    public static AuthOutboxJpaEntity create(UUID id, String aggregateType, String aggregateId,
                                             String eventType, String payload,
                                             String partitionKey, Instant createdAt) {
        return new AuthOutboxJpaEntity(id, aggregateType, aggregateId, eventType,
