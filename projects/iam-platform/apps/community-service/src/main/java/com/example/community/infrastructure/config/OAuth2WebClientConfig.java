...
public class OAuth2WebClientConfig {
    ...
    public static final String GAP_ACCOUNT_REGISTRATION_ID = "iam-account";

    /** Registration id used when calling membership-service. */
    public static final String GAP_MEMBERSHIP_REGISTRATION_ID = "iam-membership";

    /** Bean qualifier for the WebClient pre-bound to {@code iam-account}. */
    public static final String ACCOUNT_WEB_CLIENT = "accountServiceWebClient";

    /** Bean qualifier for the WebClient pre-bound to {@code iam-membership}. */
