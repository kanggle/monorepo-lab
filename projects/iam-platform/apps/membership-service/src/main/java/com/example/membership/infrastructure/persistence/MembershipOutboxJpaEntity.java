...
/**
 * Per-service transactional-outbox row for membership-service (TASK-BE-454 — outbox
 ...
 * serialises the UUID as its 36-char canonical string, matching the {@code V0007}
 ...
 * {@code OutboxMembershipEventPublisher}); the relay never parses it.
 *
 * <p>Lives under {@code com.example.membership.infrastructure.persistence} (one of
...
public class MembershipOutboxJpaEntity implements OutboxRow {
    ...
    private MembershipOutboxJpaEntity(UUID id, String aggregateType, String aggregateId,
    ...
    public static MembershipOutboxJpaEntity create(UUID id, String aggregateType, String aggregateId,
                                                   String eventType, String payload,
                                                   String partitionKey, Instant createdAt) {
        return new MembershipOutboxJpaEntity(id, aggregateType, aggregateId, eventType,
