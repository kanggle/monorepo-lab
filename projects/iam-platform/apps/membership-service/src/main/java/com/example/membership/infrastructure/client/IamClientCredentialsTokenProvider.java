...
public class IamClientCredentialsTokenProvider {
    ...
    public IamClientCredentialsTokenProvider(
            ...
            @Value("${iam.internal-client.client-id:membership-service-client}") String clientId,
            @Value("${iam.internal-client.client-secret:membership-service-secret}") String clientSecret) {
