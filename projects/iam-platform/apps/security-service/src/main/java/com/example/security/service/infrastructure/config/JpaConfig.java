 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.example.security.service.infrastructure.persistence")
@EntityScan(basePackages = "com.example.security.service.infrastructure.persistence")
