...
@Slf4j
@Configuration
@EnableConfigurationProperties({AdminJwtProperties.class, IamOidcProperties.class})
public class JwtConfig {
     ...
     */
    @Bean
    IamOidcSubjectTokenValidator gapOidcSubjectTokenValidator(
            IamOidcProperties gapOidcProperties, ObjectMapper objectMapper) {
        return new IamOidcJwksSubjectTokenValidator(gapOidcProperties, objectMapper);
    }
