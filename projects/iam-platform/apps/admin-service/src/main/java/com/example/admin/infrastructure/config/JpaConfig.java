...
/**
 * Explicit JPA scanning for the admin-service's own persistence package.
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.example.admin.infrastructure.persistence")
@EntityScan(basePackages = "com.example.admin.infrastructure.persistence")
