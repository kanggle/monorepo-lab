 ...
 */
@Slf4j
public class IamOidcJwksSubjectTokenValidator implements IamOidcSubjectTokenValidator {

    private final IamOidcProperties properties;
    ...
    public IamOidcJwksSubjectTokenValidator(IamOidcProperties properties,
