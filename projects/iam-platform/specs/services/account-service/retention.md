...
| 유예 기간 | **30일** (환경 변수로 조정 가능, 기본값 30일 — [data-model.md](./data-model.md#anonymization-삭제-유예--pii-제거)) |
...
본 절은 [data-model.md](./data-model.md#anonymization-삭제-유예--pii-제거) "Anonymization" 표를 권위 원본으로 따른다.
