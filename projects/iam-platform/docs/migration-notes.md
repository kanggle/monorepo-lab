# Migration Notes — iam-platform into monorepo-lab
...
### Removed from projects/iam-platform/
...
standalone master into `projects/iam-platform/`.
...
multi-tenancy iam-fill work. Those IDs are now occupied by standalone fix tasks.
