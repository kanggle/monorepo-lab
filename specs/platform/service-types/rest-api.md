...
- See `specs/platform/api-gateway-policy.md`

## Versioning
- Use URI path versioning for public endpoints (`/v1/`, `/v2/`)
- Follow `specs/platform/versioning-policy.md` and `cross-cutting/api-versioning.md`

## Error Handling
- Use the project-wide error envelope defined in `specs/platform/error-handling.md`
