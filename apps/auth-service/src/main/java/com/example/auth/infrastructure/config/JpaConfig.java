...
/**
 * Explicit JPA scanning for the auth-service's own persistence package.
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.example.auth.infrastructure.persistence")
@EntityScan(basePackages = "com.example.auth.infrastructure.persistence")
