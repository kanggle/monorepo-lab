...
(2026-05-19 resolution row appended per § D6.3 append-only — the 2026-05-18 ACCEPTED row's "PENDING" text is preserved verbatim as honest history; resolution is recorded as a NEW row, never a rewrite. TASK-MONO-116; impl PR#/squash backfilled at close chore.)
