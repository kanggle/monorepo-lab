...
| **TASK-BE-435** — ecommerce order stuck-detector terminal → `CANCELLED(PAYMENT_TIMEOUT)` + payment-service late-payment compensation | Adopter of the § 2.3 D3 refinement (depends on TASK-MONO-306) | ⏳ ready |
