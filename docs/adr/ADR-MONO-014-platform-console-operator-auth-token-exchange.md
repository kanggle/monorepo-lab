...
**Related:** [ADR-MONO-013](ADR-MONO-013-platform-console-foundation.md), GAP [ADR-001](../../projects/iam-platform/docs/adr/ADR-001-oidc-adoption.md) (OIDC AS), GAP [ADR-002](../../projects/iam-platform/docs/adr/) (`tenant_id='*'` platform-scope sentinel), GAP [ADR-003](../../projects/iam-platform/docs/adr/ADR-003-public-client-refresh-token-revoke-converter.md) (public-client lineage), `projects/global-account-platform/specs/services/admin-service/security.md` (operator JWT boundary), TASK-BE-296 (#568), TASK-PC-FE-001 (#569), RFC 8693 (OAuth 2.0 Token Exchange).
