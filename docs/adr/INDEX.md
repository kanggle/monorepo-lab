...
| [ADR-MONO-049](ADR-MONO-049-framework-neutral-security-library.md) | `libs/java-security`: a **framework-neutral** security library, because **49** hand-copied validators across **20 services** are only a few tests away from a fix that lands nowhere (§ 1.6 — the count was low three times; the open question is whether D5 covers all 20 or leaves 14) | PROPOSED | 2026-07-12 |
