...
**Related:** [ADR-MONO-013](ADR-MONO-013-platform-console-foundation.md) (console foundation, Model B, parent), [ADR-MONO-014](ADR-MONO-014-platform-console-operator-auth-token-exchange.md) (operator token exchange — the credential the BFF reuses for the GAP-domain leg of D4; staged-child precedent), [ADR-MONO-015](ADR-MONO-015-platform-console-dashboards-model.md) (Composed-overview pattern — the GAP-domain dashboard the Phase 7 MVP generalises across 5 domains; staged-child precedent), [ADR-MONO-007](ADR-MONO-007-worktree-ephemeral-observability-stack.md) (Vector + VictoriaMetrics — the D7 observability reuse base), TASK-PC-FE-007 #633 / TASK-PC-FE-008 #637 / TASK-PC-FE-009 #644 / TASK-PC-FE-010 #660 (the four per-domain credential rule confirmations the BFF D4 inherits verbatim).
