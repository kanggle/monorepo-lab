...
**Status:** PROPOSED
**Date:** 2026-05-13
**History:** PROPOSED 2026-05-13 — Phase 3 of the e2e 3단계 전략 (skip / light / full). Phase 2 (ADR-MONO-010, PROPOSED+ACCEPTED 2026-05-13, PR #427/#428) authorised the partition (`@Tag("smoke")` PR-time / `@Tag("full")` nightly) and wired the 4 service-side `:e2eFullTest` Gradle tasks. Phase 3 wires the CI side: the cron + push-to-main triggers, the 4 backend jobs, and the failure-handling policy.
...
|---|---|---|---|---|---|
| 1 | 2026-05-13 | — | PROPOSED | TBD | Initial publication (this PR). |
| 2 | (pending) | PROPOSED | ACCEPTED | TBD | User-explicit intent + readiness reconfirmation; TASK-MONO-079 impl unblocked. |
