...
| wms | 4 | 3 |
| finance | **3** | 0 |
| platform-console 자신 (login·tenants·operators·permission-sets·org-hierarchy·dashboards…) | 12 | 3 |

🔵 **erp · iam · finance 는 오늘 확보분만으로 채울 수 있다** — 못 쓰는 장이 0이다.
