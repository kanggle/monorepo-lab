    ...
    tables: [
      {
        ...
        rows: [
          ...
          { domain: 'IAM', status: '정상', latency: '29ms' },
          { domain: '팬 플랫폼', status: '정상', latency: '52ms' },
          { domain: '콘솔', status: '정상', latency: '18ms' },
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          { orderNo: 'DEMO-2026-0908', customer: '데모 고객 D', amount: '189,000원', status: '결제완료' },
          { orderNo: 'DEMO-2026-0907', customer: '데모 고객 B', amount: '2,090,000원', status: '출고대기' },
          { orderNo: 'DEMO-2026-0906', customer: '데모 고객 E', amount: '24,000원', status: '배송중' },
          { orderNo: 'DEMO-2026-0905', customer: '데모 고객 C', amount: '349,000원', status: '배송완료' },
          { orderNo: 'DEMO-2026-0904', customer: '데모 고객 A', amount: '62,000원', status: '취소' },
        ],
      },
      {
        key: 'products',
        ...
        rows: [
          ...
          { name: '노이즈 캔슬링 무선 이어버드', price: '189,000원', status: '판매중' },
          { name: '스마트워치 7', price: '349,000원', status: '판매중' },
          { name: '스페셜티 원두 500g', price: '24,000원', status: '판매중' },
          { name: '아이폰 17 프로', price: '1,690,000원', status: '판매중' },
          { name: '울트라북 14인치', price: '1,890,000원', status: '품절' },
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          { sku: 'DEMO-EARBUDS-BK', location: 'B-02-04', qty: 60 },
          { sku: 'DEMO-WATCH-41S', location: 'B-03-01', qty: 30 },
          { sku: 'DEMO-COFFEE-500', location: 'C-01-05', qty: 80 },
          { sku: 'DEMO-CHINO-32', location: 'A-03-02', qty: 45 },
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          { poNo: 'DEMO-PO-2026-038', supplier: '데모 공급사 3', items: 6, status: '승인대기' },
          { poNo: 'DEMO-PO-2026-037', supplier: '데모 공급사 2', items: 4, status: '입고예정' },
          { poNo: 'DEMO-PO-2026-036', supplier: '데모 공급사 3', items: 1, status: '반려' },
          { poNo: 'DEMO-PO-2026-035', supplier: '데모 공급사 1', items: 8, status: '입고완료' },
          { poNo: 'DEMO-PO-2026-034', supplier: '데모 공급사 2', items: 3, status: '입고완료' },
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          { docNo: 'DEMO-AP-1039', title: '물류 자동화 설비 도입 검토', requester: '데모 사원 A', status: '결재대기' },
          { docNo: 'DEMO-AP-1038', title: '3분기 채용 계획', requester: '데모 사원 D', status: '진행중' },
          { docNo: 'DEMO-AP-1037', title: '사내 교육 예산 집행', requester: '데모 사원 B', status: '승인' },
          { docNo: 'DEMO-AP-1036', title: '거래처 결제 조건 변경', requester: '데모 사원 E', status: '반려' },
          { docNo: 'DEMO-AP-1035', title: '창고 안전 점검 결과 보고', requester: '데모 사원 C', status: '승인' },
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          { account: '외상매출금', debit: '3,240,000원', credit: '0원' },
          { account: '부가세예수금', debit: '0원', credit: '1,248,000원' },
          { account: '급여', debit: '5,600,000원', credit: '0원' },
          { account: '감가상각비', debit: '820,000원', credit: '0원' },
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          { slug: 'demo-fan', domains: '팬 플랫폼', status: '활성' },
          { slug: 'demo-logistics', domains: 'WMS, SCM', status: '활성' },
          { slug: 'demo-finance-only', domains: '재무', status: '활성' },
          { slug: 'demo-onboarding', domains: '—', status: '준비중' },
        ],
      },
    ],
  },
