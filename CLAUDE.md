...
- **`.claude/` is classifier-blocked**: edits/commits under `.claude/hooks|agents|commands` are hard-blocked even with approval → hand the patch to the user. `platform/` is not subject.
